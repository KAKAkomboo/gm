...
def movement_blocks(keys, paddle_1y, paddle_2y, screen_size, paddle_height, movement):
    ...
    if keys[pygame.K_DOWN] and paddle_2y < screen_size[1] - paddle_height:
        paddle_2y = paddle_2y + movement
    return paddle_1y, paddle_2y


def movement_ball(ball_x, ball_y, ball_speed_x, ball_speed_y, screen_size, paddle_1x, paddle_width, paddle_height, paddle_1y, paddle_2x, paddle_2y):
...
while running:
    ...
    paddle_1y, paddle_2y = movement_blocks(keys, paddle_1y, paddle_2y, screen_size, paddle_height, movement)
    ball_x, ball_y, ball_speed_x, ball_speed_y = movement_ball(ball_x, ball_y, ball_speed_x, ball_speed_y, screen_size, paddle_1x, paddle_width, paddle_height, paddle_1y, paddle_2x, paddle_2y)
